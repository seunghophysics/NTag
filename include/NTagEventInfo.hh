...
class NTagEventInfo
{
    public:
        ...
        * 
        * Default search settings for capture candidates, i.e., the range of N10 and T0,
        ...
        */
        NTagEventInfo(Verbosity verbose /**< The verbosity of NTagEventInfo and all of its daughter classes. */);
        /** 
        ...
        */
        ...
        // Functions to set variables
            ...
            virtual void         SetMCInfo();
                                /**
                                 * @brief Reads secondary bank from input file and fills \c secndprt common. Called inside NTagEventInfo::SetMCInfo.
                                 * @see: NTagZBS::ReadSecondaries, NTagROOT::ReadSecondaries
                                 */
            virtual void         ReadSecondaries();
                                /**
                                 * @brief Set true capture information. 
        ...
        // Variable-related functions
            ...
            int                  IsCapture(int candidateID, bool bSave=false);
                                 ...
                                 * then returns \c true. Otherwise returns \c false.
                                 * @param candidateID The ID of a capture candidate.
                                 * @param bSave If \c true and \p candidateID matches as a true capture, \p candidateID is pushed back to #vCandidateID.
                                 * @return \c true if the reconstructed capture time matches a true capture time, otherwise \c false.
                                 */
            ...
            int                  GetNhitsFromStartIndex(const std::vector<float>& T, int startIndex, float tWidth);
                                 ...
                                 * @param tWidth The width of the time window [ns] to count hits within. \p centerTime comes in the center of this \p tWidth.
            ...
            int                  GetNhitsFromCenterTime(const std::vector<float>& T, float centerTime, float tWidth);
                                 ...
                                 * @param T A vector of PMT hit times. [ns]
                                 * @param Q A vector of deposited charge. [p.e.] Each element of \p Q must correspond to the element of \p T with the same index.
                                 * @param startIndex The \p T index of the first hit in a hit cluster or a capture candidate.
                                 * @param tWidth The width of the time window [ns] to count hits within.
                                 * @return The summed charge [p.e.] of a hit cluster or a capture candidate from \p startIndex within \p tWidth [ns].
                                 */              
    ...
    private:
        const float (*PMTXYZ)[3];           ///< A map from PMT cable ID to coordinates.
        ...
        std::vector<float>  vSortedT_ToF, /*!< A vector of ToF-subtracted hit times [ns] sorted in ascending order. 
                            ...
                            vUnsortedT_ToF, /*!< A vector of unsorted ToF-subtracted hit times [ns], in the order as in #vTISKZ. */
    ...
    protected:
        ...
        /**/                        qismsk; /*!< Total p.e. deposited in ID within 1.3 us around the main trigger of an event. */
        /**/
        ...
        /**/    float               evis; /*!< Visible energy (the amount of energy if the peak was from an electron). */
        /**/
        /**/    // APFit variables
        ...
        /**/    std::vector<float>  vAPMom, /*!< Vector of momentum corresponding to each ring found by APFit. [Size: #apNRings] */
        /**/                        vAPMomE, /*!< Vector of e-like momentum corresponding to each ring found by APFit. [Size: #apNRings] */
        /**/                        vAPMomMu; /*!< Vector of mu-like momentum corresponding to each ring found by APFit. [Size: #apNRings] */
        /**/
        ...
        /**/                            firstHitTime_ToF; /*!< The earliest hit time in an event, subtracted by the ToF from the prompt vertex. */
        ...
        /**/        std::vector<float>  vReconCTn, /*!< Vector of Neut-fit reconstructed capture time. [Size: #nCandidates] */
        /**/                            vNvx, /*!< Vector of X coordinates of Neut-fit capture vertex. [Size: #nCandidates] */
        /**/                            vNvy, /*!< Vector of Y coordinates of Neut-fit capture vertex. [Size: #nCandidates] */
        /**/                            vNvz; /*!< Vector of Z coordinates of Neut-fit capture vertex. [Size: #nCandidates] */
        /**/
        /**/        // BONSAI variables
        /**/        std::vector<float>  vBSvx, /*!< Vector of X coordinates of BONSAI-fit capture vertex. [Size: #nCandidates] */
        /**/                            vBSvy, /*!< Vector of X coordinates of BONSAI-fit capture vertex. [Size: #nCandidates] */
        /**/                            vBSvz, /*!< Vector of X coordinates of BONSAI-fit capture vertex. [Size: #nCandidates] */
        /**/                            vBSReconCT; /*!< Vector of BONSAI-fit capture time. [ns] [Size: #nCandidates] */
        /**/
        /**/        // Beta variables
        /**/        std::vector<float>  vBeta14_10, /*!< Vector of &beta;_14's in 10 ns window. [Size: #nCandidates] */
        /**/                            vBeta14_50; /*!< Vector of &beta;_14's in 50 ns window. [Size: #nCandidates] */
        /**/
        /**/    // TMVA output
        /**/    std::vector<float>  vTMVAOutput; /*!< Vector of TMVA classifier outputs. [Size: #nCandidates] */
        /**/
        /************************************************************************************************/
        ...
        /**/    std::vector<int>    vNGamma, /*!< Vector of the total numbers of emitted gammas in true capture. [Size: #nTrueCaptures] */
        ...
        /**/    std::vector<float>  vTrueCT, /*!< Vector of true capture times. [ns] [Size: #nTrueCaptures] */
                                    vCapVX, /*!< Vector of X coordinates of true capture vertices. [cm] [Size: #nTrueCaptures] */
                                    vCapVY, /*!< Vector of Y coordinates of true capture vertices. [cm] [Size: #nTrueCaptures] */
                                    vCapVZ, /*!< Vector of Z coordinates of true capture vertices. [cm] [Size: #nTrueCaptures] */
                                    vTotGammaE; /*!< Vector of the total emitted gamma energies. [MeV] [Size: #nTrueCaptures] */
        /**/
        /**/    // Variables for neutron capture candidates
        /**/    std::vector<int>    vIsGdCapture, /*!< Vector of true-Gd-capture flags. 1 for \c true and 0 for \c false. [Size: #nCandidates] */
                                    vIsCapture, /*!< Vector of true-capture flags. 1 for \c true and 0 for \c false. [Size: #nCandidates] */
                                    vDoubleCount; /*!< Vector of double-count flags. 1 for \c true and 0 for \c false. [Size: #nCandidates] */
        /**/    std::vector<float>  vTrueCapVX, /*!< Vector of X coordinate of corresponding true capture vertex. [Size: #nCandidates] */
                                    vTrueCapVY, /*!< Vector of Y coordinate of corresponding true capture vertex. [Size: #nCandidates] */
                                    vTrueCapVZ, /*!< Vector of Z coordinate of corresponding true capture vertex. [Size: #nCandidates] */
                                    vCTDiff; /*!< Vector of capture time differences between a capture candidate and corresponding true capture. [Size: #nCandidates] */
        /**/
        ...
        /**/    std::vector<int> 	vSecPID, /*!< Vector of saved secondary PIDs. [Size: #nSavedSec] */
                                    ...
                                    vCapID;/*!< Vector of true capture indices that generates the secondary. 
                                                -1 is pushed back if the secondary is not from a neutron capture. [Size: #nSavedSec] */
        /**/    std::vector<float> 	vSecVX, /*!< Vector of X coordinates of secondary vertices. [cm] [Size: #nSavedSec] */
                                    ...
                                    vSecPX, /*!< Vector of X-direction initial momenta of secondaries. [MeV/c] [Size: #nSavedSec] */
                                    vSecPY, /*!< Vector of Y-direction initial momenta of secondaries. [MeV/c] [Size: #nSavedSec] */
                                    vSecPZ; /*!< Vector of Z-direction initial momenta of secondaries. [MeV/c] [Size: #nSavedSec] */
        /**/    std::vector<float> 	vSecDWall, /*!< Vector of distances from secondary vertices to the SK barrel. [cm] [Size: #nSavedSec] */
